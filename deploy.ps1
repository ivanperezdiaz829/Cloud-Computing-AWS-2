# =======================================
# SCRIPT DE DESPLIEGUE AWS - POWERSHELL
# =======================================

# --- 1. CONFIGURACION ---
$env:AWS_REGION = "us-east-1"

# Asegurar cuenta de LabRole
...
# Redirigir stderr a null para limpiar la salida si ya existen
...
try {
    aws kinesis create-stream --stream-name laptops-stream --shard-count 1 2>$null
} catch {
...
# Verificar que exista el archivo python
...
aws firehose create-delivery-stream `
    ...
    --kinesis-stream-source-configuration "KinesisStreamARN=arn:aws:kinesis:$($env:AWS_REGION):$($env:ACCOUNT_ID):stream/laptops-stream,RoleARN=$env:ROLE_ARN" `
...
Write-Host "1. Ejecutar 'uv run kinesis.py' para enviar datos."
Write-Host "2. Espera 2-5 minutos."
Write-Host "3. Comprobar dentro de AWS Glue."
Write-Host "4. Ejecutar los Jobs 'laptops-analytics-brand' y 'laptops-analytics-opsys'."